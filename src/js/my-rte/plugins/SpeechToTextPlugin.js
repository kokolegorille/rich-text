...
const VOICE_COMMANDS = (arg0) => {
    switch (arg0) {
        case "\n": 
            return ({ selection }) => { selection.insertParagraph(); }
        case "redo": 
            return ({ editor }) => { editor.dispatchCommand(REDO_COMMAND, undefined); }
        case "undo":
            return ({ editor }) => { editor.dispatchCommand(UNDO_COMMAND, undefined); }
    }
};
